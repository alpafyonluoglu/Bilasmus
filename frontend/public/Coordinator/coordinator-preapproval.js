...
let tableHTML = '<div class="row"><div class="row">'+
'<div class="col-xxl-1">'+
...
fetch("https://bilasmus.uc.r.appspot.com/file/pa/this/?s=" +  getCookie("sessionID"))
.then((response) => {
    ...
    //if (data.loggedIn === true){
      $.each(data, (index, data) => {
        tableHTML += tableHTML;
        document.getElementById("studentNamePreApproval").value = data.name;
        document.getElementById("datePreApproval").value = data.uploadDate;
